...
import Pino from 'pino'
import { TanyJadiBot } from './plugins/jadibot-serbot.js'
...
TanyJadiBot({pathTanyJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
